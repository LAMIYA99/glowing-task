...
const sliderContainer = document.querySelector("#sliderContent");


createSwiper(".product-slider", 4, 30);
createSwiper(".mySwiper", 1, 0);



function createSwiper(selector, view, gap) {
      ...
      <div class="swiper-slide" >
       ...
       <button>${item.badge}</button>
            ...
            <div class="hoverImg absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-600 cursor-pointer overflow-hidden">
              <img src="${item?.hoverImg}" alt="${item.title
...
function renderProducts() {
    ...
    let products = items
      ...
      .join("");
    PRODUCT_WRAPPER.innerHTML = products;
  } 
